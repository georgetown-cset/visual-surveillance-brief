...
<details> <summary>  We extended our analysis to the full CSET database of papers from MAG, Dimensions, the Web of Science Core Collection (WOS), and the China National Knowledge Infrastructure (CNKI) by identifying the clusters of research papers most likely to contain visual surveillance papers. </summary>
