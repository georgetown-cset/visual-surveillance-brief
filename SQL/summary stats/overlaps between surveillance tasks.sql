...
facerec_papers AS(
SELECT DISTINCT merged_id FROM task_papers
...
SELECT * from overlap_share
UNION ALL
SELECT base_task, multiple_task_papers, NULL, NP, overlap_fraction, NULL from overall_surv_stats
